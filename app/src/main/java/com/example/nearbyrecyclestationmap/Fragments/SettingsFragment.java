...
import com.example.nearbyrecyclestationmap.Activity.ModeSelectionActivity;
...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.cardMode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent mode = new Intent(requireContext(), ModeSelectionActivity.class);
                startActivity(mode);
            }
        });
        ...
        binding.cardLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intentL = new Intent(requireContext(), LoginActivity.class);
