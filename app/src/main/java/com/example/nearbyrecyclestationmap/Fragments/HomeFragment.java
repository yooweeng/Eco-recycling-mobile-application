...
import com.example.nearbyrecyclestationmap.Activity.DirectionActivity;
import com.example.nearbyrecyclestationmap.Activity.MainActivity;
import com.example.nearbyrecyclestationmap.Adapter.GooglePlaceAdapter;
import com.example.nearbyrecyclestationmap.Adapter.InfoWindowAdapter;
import com.example.nearbyrecyclestationmap.Constant.AllConstant;
...
import com.example.nearbyrecyclestationmap.NearLocationInterface;
import com.example.nearbyrecyclestationmap.Permissions.AppPermissions;
import com.example.nearbyrecyclestationmap.PlaceModel;
import com.example.nearbyrecyclestationmap.R;
import com.example.nearbyrecyclestationmap.SavedPlaceModel;
import com.example.nearbyrecyclestationmap.Utility.LoadingDialog;
import com.example.nearbyrecyclestationmap.WebServices.RetrofitAPI;
import com.example.nearbyrecyclestationmap.WebServices.RetrofitClient;
import com.example.nearbyrecyclestationmap.databinding.FragmentHomeBinding;
...
GoogleMap.OnMarkerClickListener, NearLocationInterface {
    ...
    private String keyword = "recycle";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.ivSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String location = binding.edtPlaceName.getText().toString();
                if (location==null){
                    Toast.makeText(requireContext(),"Please type a location name", Toast.LENGTH_SHORT).show();
                }else
                {
                    keyword = location;
                    getPlaces(location);
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        if (appPermissions.isLocationOk(requireContext())) {
            ...
            new AlertDialog.Builder(requireContext())
                    ...
                    .setMessage("ECO required location permission to show you near by places")
    ...
    private void getPlaces(String placeName) {
        ...
        if (isLocationPermissionOk) {
            ...
            String url = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location="
                    ...
                    + "&radius=" + radius + "&type=" + placeName + "&keyword=" + keyword + "&key=" +
